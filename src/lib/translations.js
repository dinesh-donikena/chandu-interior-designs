...
export const translations = {
  en: {
    ...
    portfolio: {
      title: "Our Work",
      intro:
        "Photos from a recent home renovation in Hanamakonda, along with a few sample designs that show the kind of work we do.",
      filters: {
        all: "All",
        hall: "Hall",
        kitchen: "Kitchen",
  ...
  te: {
    ...
    portfolio: {
      title: "మా పనులు",
      intro:
        "హనుమకొండలో ఇటీవల చేసిన ఇంటి రెనొవేషన్ ఫోటోలు, వాటితో పాటు మేము చేసే పనుల తరహాను చూపించే కొన్ని శాంపిల్ డిజైన్లు.",
      filters: {
        all: "అన్నీ",
        hall: "హాల్",
        kitchen: "కిచెన్",
