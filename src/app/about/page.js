...
export const metadata = {
  title: "About",
  description:
    "Meet the designer behind Chandu Interior Designs. Learn about our philosophy of blending Warangal heritage with modern minimalism.",
};
...
const values = [
  {
    ...
    desc: "We source the finest local materials and work with heritage artisans to ensure every detail stands the test of time.",
    icon: (
  ...
  },
  {
    ...
    desc: "Your space is a portrait of your soul. We listen deeply to curate an environment that echoes your unique lifestyle.",
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1}>
  ...
  },
  {
    ...
    desc: "We push boundaries by integrating modern technology and spatial flow into traditional architectural frameworks.",
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          ...
          <div className="md:col-span-6 md:col-start-7">
            ...
            <div className="space-y-6 text-on-surface-muted text-base leading-relaxed">
              <p>
                Born and raised amidst the architectural grandeur of
                Hanamakonda, my journey into design began with an obsession for
                intricate stone carvings and how light dances across ancient
                textures, creating a sense of permanence and peace — a feeling I
                now strive to recreate in every home.
              </p>
              <p>
                My philosophy is rooted in &ldquo;Quiet Luxury.&rdquo; I believe
                that a space should not shout; it should breathe. By blending the
                rich heritage of Warangal&apos;s craftsmanship with the clean
                lines of modern minimalism, I create interiors that feel both
                timeless and deeply personal.
              </p>
              <p>
                Beyond aesthetics, my commitment lies with the local community.
                We collaborate with master artisans in the region, ensuring that
                every project supports the heritage skills that make our city
                unique.
              </p>
            </div>
            <div className="mt-10 pt-10 border-t border-outline-light/30 flex items-center gap-4">
              ...
              <p className="text-xs font-semibold text-secondary uppercase tracking-[0.1em]">
                Award Winning Studio &bull; 15+ Years Excellence
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 md:py-32">
        <div className="max-w-3xl mx-auto px-5 text-center">
          ...
          <p className="font-display text-2xl md:text-3xl italic text-primary leading-snug">
            &ldquo;True luxury is found in the absence of noise. It&apos;s the
            balance of history, texture, and light that makes a house a
            heritage.&rdquo;
          </p>
          <div className="mt-8">
